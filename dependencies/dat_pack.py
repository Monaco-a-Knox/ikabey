...
PackName = 'data2.dat'
#ExpectHeader = None
ExpectHeader = bytes.fromhex('DA C7 C4 D5 F2 77 1F 17') #在此处填写原包开头第0x10~0x17字节，不为空时会自动匹配配置 #bytes do offstet 0x10~07
#1B A9 0D 48 43 7F 63 14 kaziklu jp
#GameType = 'Dies Irae ~Amantes amentes~' #仅在ExpectHeader无效时使用 #nome do jogo no header
IfEncrypt = True
CheckPlain = [0] * 0x10 #需要检查的明文 #plaintext to check
CheckOffset = 0x10 #需要检查的明文长度 #lenght of plaintext
